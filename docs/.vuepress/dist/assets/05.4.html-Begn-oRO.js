import{_ as o,c as l,a as i,b as a,f as s,d as t,e as p,r as c,o as r}from"./app-DtITwm2S.js";const u={};function d(k,n){const e=c("RouteLink");return r(),l("div",null,[n[22]||(n[22]=i(`<h1 id="_5-4-for-结构" tabindex="-1"><a class="header-anchor" href="#_5-4-for-结构"><span>5.4 for 结构</span></a></h1><p>如果想要重复执行某些语句，Go 语言中您只有 <code>for</code> 结构可以使用。不要小看它，这个 <code>for</code> 结构比其它语言中的更为灵活。</p><p><strong>注意事项</strong> 其它许多语言中也没有发现和 do-while 完全对等的 <code>for</code> 结构，可能是因为这种需求并不是那么强烈。</p><h2 id="_5-4-1-基于计数器的迭代" tabindex="-1"><a class="header-anchor" href="#_5-4-1-基于计数器的迭代"><span>5.4.1 基于计数器的迭代</span></a></h2><p>文件 for1.go 中演示了最简单的基于计数器的迭代，基本形式为：</p><pre><code>for 初始化语句; 条件语句; 修饰语句 {}
</code></pre><p>示例 5.6 <a href="examples/chapter_5/for1.go">for1.go</a>：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
...
<span class="line">	<span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果您使用 for 循环迭代一个 Unicode 编码的字符串，会发生什么？</p><p>示例 5.7 <a href="examples/chapter_5/for_string.go">for_string.go</a>：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;fmt&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
</code></pre><p>如果我们打印 <code>str</code> 和 <code>str2</code> 的长度，会分别得到 <code>27</code> 和 <code>9</code>。</p>`,8)),a("p",null,[n[6]||(n[6]=s("由此我们可以发现，ASCII 编码的字符占用 1 个字节，既每个索引都指向不同的字符，而非 ASCII 编码的字符（占有 2 到 4 个字节）不能单纯地使用索引来判断是否为同一个字符。我们会在")),t(e,{to:"/chapter-2/05.4.html"},{default:p(()=>n[5]||(n[5]=[s("第 5.4.4 节")])),_:1}),n[7]||(n[7]=s(" 解决这个问题。"))]),n[24]||(n[24]=i(`<h3 id="练习题" tabindex="-1"><a class="header-anchor" href="#练习题"><span>练习题</span></a></h3><p><strong>练习 5.4</strong> <a href="exercises/chapter_5/for_loop.go">for_loop.go</a></p><ol><li>使用 <code>for</code> 结构创建一个简单的循环。要求循环 15 次然后使用 <code>fmt</code> 包来打印计数器的值。</li><li>使用 <code>goto</code> 语句重写循环，要求不能使用 <code>for</code> 关键字。</li></ol><p><strong>练习 5.5</strong> <a href="exercises/chapter_5/for_character.go">for_character.go</a></p><p>创建一个程序，要求能够打印类似下面的结果（尾行达 25 个字符为止）：</p><pre><code>G
GG
GGG
GGGG
GGGGG
GGGGGG
</code></pre><ol><li>使用 2 层嵌套 for 循环。</li><li>仅用 1 层 for 循环以及字符串连接。</li></ol><p><strong>练习 5.6</strong> <a href="exercises/chapter_5/bitwise_complement.go">bitwise_complement.go</a></p><p>使用按位补码从 0 到 10，使用位表达式 <code>%b</code> 来格式化输出。</p><p><strong>练习 5.7</strong> Fizz-Buzz 问题：<a href="exercises/chapter_5/fizzbuzz.go">fizzbuzz.go</a></p><p>写一个从 1 打印到 100 的程序，但是每当遇到 3 的倍数时，不打印相应的数字，但打印一次 &quot;Fizz&quot;。遇到 5 的倍数时，打印 <code>Buzz</code> 而不是相应的数字。对于同时为 3 和 5 的倍数的数，打印 <code>FizzBuzz</code>（提示：使用 switch 语句）。</p><p><strong>练习 5.8</strong> <a href="exercises/chapter_5/rectangle_stars.go">rectangle_stars.go</a></p><p>使用 <code>*</code> 符号打印宽为 20，高为 10 的矩形。</p><h2 id="_5-4-2-基于条件判断的迭代" tabindex="-1"><a class="header-anchor" href="#_5-4-2-基于条件判断的迭代"><span>5.4.2 基于条件判断的迭代</span></a></h2><p>for 结构的第二种形式是没有头部的条件判断迭代（类似其它语言中的 while 循环），基本形式为：<code>for 条件语句 {}</code>。</p><p>您也可以认为这是没有初始化语句和修饰语句的 for 结构，因此 <code>;;</code> 便是多余的了。</p><p>Listing 5.8 <a href="examples/chapter_5/for2.go">for2.go</a>：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;fmt&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
The variable i is now: -1
</code></pre><h2 id="_5-4-3-无限循环" tabindex="-1"><a class="header-anchor" href="#_5-4-3-无限循环"><span>5.4.3 无限循环</span></a></h2><p>条件语句是可以被省略的，如 <code>i:=0; ; i++</code> 或 <code>for { }</code> 或 <code>for ;; { }</code>（<code>;;</code> 会在使用 gofmt 时被移除）：这些循环的本质就是无限循环。最后一个形式也可以被改写为 <code>for true { }</code>，但一般情况下都会直接写 <code>for { }</code>。</p><p>如果 for 循环的头部没有条件语句，那么就会认为条件永远为 true，因此循环体内必须有相关的条件判断以确保会在某个时刻退出循环。</p><p>想要直接退出循环体，可以使用 break 语句（第 5.5 节）或 return 语句直接返回（第 6.1 节）。</p><p>但这两者之间有所区别，break 只是退出当前的循环体，而 return 语句提前对函数进行返回，不会执行后续的代码。</p><p>无限循环的经典应用是服务器，用于不断等待和接受新的请求。</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">for</span> t<span class="token punctuation">,</span> err <span class="token operator">=</span> p<span class="token punctuation">.</span><span class="token function">Token</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> err <span class="token operator">==</span> <span class="token boolean">nil</span><span class="token punctuation">;</span> t<span class="token punctuation">,</span> err <span class="token operator">=</span> p<span class="token punctuation">.</span><span class="token function">Token</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">	<span class="token operator">...</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-4-4-for-range-结构" tabindex="-1"><a class="header-anchor" href="#_5-4-4-for-range-结构"><span>5.4.4 for-range 结构</span></a></h2>`,28)),a("p",null,[n[10]||(n[10]=s("这是 Go 特有的一种的迭代结构，您会发现它在许多情况下都非常有用。它可以迭代任何一个集合（包括数组和 ")),n[11]||(n[11]=a("code",null,"map",-1)),n[12]||(n[12]=s("，详见第 ")),t(e,{to:"/chapter-2/07.0.html"},{default:p(()=>n[8]||(n[8]=[s("7")])),_:1}),n[13]||(n[13]=s(" 和 ")),t(e,{to:"/chapter-2/08.0.html"},{default:p(()=>n[9]||(n[9]=[s("8")])),_:1}),n[14]||(n[14]=s(" 章）。语法上很类似其它语言中的 foreach 语句，但您依旧可以获得每次迭代所对应的索引。一般形式为：")),n[15]||(n[15]=a("code",null,"for ix, val := range coll { }",-1)),n[16]||(n[16]=s("。"))]),n[25]||(n[25]=i(`<p>要注意的是，<code>val</code> 始终为集合中对应索引的值拷贝，因此它一般只具有只读性质，对它所做的任何修改都不会影响到集合中原有的值（<strong>译者注：如果 <code>val</code> 为指针，则会产生指针的拷贝，依旧可以修改集合中的原值</strong>）。一个字符串是 Unicode 编码的字符（或称之为 <code>rune</code>）集合，因此您也可以用它迭代字符串：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">for</span> pos<span class="token punctuation">,</span> char <span class="token operator">:=</span> <span class="token keyword">range</span> str <span class="token punctuation">{</span></span>
<span class="line"><span class="token operator">...</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每个 <code>rune</code> 字符和索引在 for-range 循环中是一一对应的。它能够自动根据 UTF-8 规则识别 Unicode 编码的字符。</p><p>示例 5.9 <a href="examples/chapter_5/range_string.go">range_string.go</a>：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;fmt&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">	<span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">The length of str is: 27</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>请将输出结果和 Listing 5.7（<a href="examples/chapter_5/for_string.go">for_string.go</a>）进行对比。</p><p>我们可以看到，常用英文字符使用 1 个字节表示，而汉字（<strong>译者注：严格来说，“Chinese: 日本語”的 Chinese 应该是 Japanese</strong>）使用 3 个字符表示。</p><p><strong>练习 5.9</strong> 以下程序的输出结果是什么？</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">for</span> i <span class="token operator">:=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">5</span><span class="token punctuation">;</span> i<span class="token operator">++</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>问题 5.2：</strong> 请描述以下 for 循环的输出结果：</p><ol><li></li></ol><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">for</span> i <span class="token operator">:=</span> <span class="token number">0</span><span class="token punctuation">;</span> <span class="token punctuation">;</span> i<span class="token operator">++</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li></li></ol><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line">s <span class="token operator">:=</span> <span class="token string">&quot;&quot;</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="链接" tabindex="-1"><a class="header-anchor" href="#链接"><span>链接</span></a></h2>`,21)),a("ul",null,[a("li",null,[t(e,{to:"/chapter-2/directory.html"},{default:p(()=>n[17]||(n[17]=[s("目录")])),_:1})]),a("li",null,[n[19]||(n[19]=s("上一节：")),t(e,{to:"/chapter-2/05.3.html"},{default:p(()=>n[18]||(n[18]=[s("switch 结构")])),_:1})]),a("li",null,[n[21]||(n[21]=s("下一节：")),t(e,{to:"/chapter-2/05.5.html"},{default:p(()=>n[20]||(n[20]=[s("Break 与 continue")])),_:1})])])])}const m=o(u,[["render",d],["__file","05.4.html.vue"]]),b=JSON.parse('{"path":"/chapter-2/05.4.html","title":"5.4 for 结构","lang":"zh-cn","frontmatter":{},"headers":[{"level":1,"title":"5.4 for 结构","slug":"_5-4-for-结构","link":"#_5-4-for-结构","children":[{"level":2,"title":"5.4.1 基于计数器的迭代","slug":"_5-4-1-基于计数器的迭代","link":"#_5-4-1-基于计数器的迭代","children":[{"level":3,"title":"练习题","slug":"练习题","link":"#练习题","children":[]}]},{"level":2,"title":"5.4.2 基于条件判断的迭代","slug":"_5-4-2-基于条件判断的迭代","link":"#_5-4-2-基于条件判断的迭代","children":[]},{"level":2,"title":"5.4.3 无限循环","slug":"_5-4-3-无限循环","link":"#_5-4-3-无限循环","children":[]},{"level":2,"title":"5.4.4 for-range 结构","slug":"_5-4-4-for-range-结构","link":"#_5-4-4-for-range-结构","children":[]},{"level":2,"title":"链接","slug":"链接","link":"#链接","children":[]}]}],"git":{},"filePathRelative":"chapter-2/05.4.md"}');export{m as comp,b as data};
